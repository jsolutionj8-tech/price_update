...
<head>
	...
	<style>
		...
		/* Badge "Member"/"Non Member" di daftar RSVP event — "Non Member" pakai .badge-nominal
		   (frame putih, tulisan biru atambah) yg sudah ada spy jadi cerminan warna dari "Member"
		   (bg-brand solid). Lebar keduanya disamakan (6.5rem), juga disamakan dgn badge kolom
		   Status (Paid/Pending) di tabel yg sama — lihat .rsvp-status-cell di bawah. */
		.badge.bg-brand, .badge.badge-nominal { display: inline-block; width: 6.5rem; text-align: center; }
		.rsvp-status-cell .badge { display: inline-block; width: 6.5rem; text-align: center; }
