<div style="font-family:'Plus Jakarta Sans',Arial,sans-serif;max-width:520px;margin:0 auto;background:#F7F2E9;padding:24px;">
	<div style="text-align:center;margin-bottom:18px;">
		...
		<div style="font-size:24px;color:#201B14;margin-top:6px;"><?= htmlspecialchars($event['event_name'] !== '' ? $event['event_name'] : 'Atambah') ?></div>
	</div>

	<p style="font-family:'Plus Jakarta Sans',Arial,sans-serif;font-size:14px;color:#3a3226;">
	...
	<div style="background:#E8D9BE;border-radius:8px;padding:14px 16px;margin-top:14px;font-family:'Plus Jakarta Sans',Arial,sans-serif;">
	...
	<div style="text-align:center;margin-top:22px;">
		<a href="<?= base_url('rsvp-ticket/' . $rsvp['ticket_code']) ?>" style="display:inline-block;background:#201B14;color:#fff;text-decoration:none;font-family:'Plus Jakarta Sans',Arial,sans-serif;font-size:13px;font-weight:bold;padding:12px 28px;border-radius:8px;">Lihat E-Tiket &amp; Barcode</a>
	</div>
	...
	<p style="font-family:'Plus Jakarta Sans',Arial,sans-serif;font-size:11px;color:#8A7F6D;text-align:center;margin-top:22px;">
		Tunjukkan barcode di atas saat tiba di lokasi acara. Email ini dikirim otomatis oleh sistem RSVP <?= htmlspecialchars($event['event_name'] !== '' ? $event['event_name'] : 'Atambah') ?>.
	</p>
</div>
